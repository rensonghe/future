...
def add_factor_process(depth, trade):
    ...
    df['inf_ratio'] = inf_ratio(depth=None, trade=trade, rolling=1000)
    df['arrive_rate'] = arrive_rate(depth=None, trade=trade, rolling=1000)
    df['arrive_rate_2'] = arrive_rate_2(depth=None, trade=trade, rolling=1000)
    df['depth_price_range'] = depth_price_range(depth=depth, trade=None)
    df['bp_rank'] = bp_rank(depth=depth, trade=None, rolling=1000)
    df['ap_rank'] = ap_rank(depth=depth, trade=None, rolling=1000)
    ...
    df['rolling_return'] = rolling_return(depth=depth, trade=None, rolling=1000)
    df['buy_increasing'] = buy_increasing(depth=None, trade=trade, rolling=1000)
    df['sell_increasing'] = sell_increasing(depth=None, trade=trade, rolling=1000)
    ...
    df['quasi'] = quasi(depth=depth, trade=None, rolling=1000)
    df['last_range'] = last_range(depth=None, trade=trade, rolling=1000)
    df['avg_trade_volume'] = avg_trade_volume(depth=depth, trade=trade, rolling=1200)
    df['avg_spread'] = avg_spread(depth=depth, trade=None, rolling=1000)
    df['avg_turnover'] = avg_turnover(depth=depth, trade=trade, rolling=1000)
    df['abs_volume_kurt'] = abs_volume_kurt(depth=None, trade=trade,rolling=1000)
    df['abs_volume_skew'] = abs_volume_skew(depth=None, trade=trade, rolling=1000)
    df['volume_kurt'] = volume_kurt(depth=None, trade=trade, rolling=1000)
    df['volume_skew'] = volume_skew(depth=None, trade=trade, rolling=1000)
    df['price_kurt'] = price_kurt(depth=None, trade=trade, rolling=1000)
    df['price_skew'] = price_skew(depth=None, trade=trade, rolling=1000)
    df['bv_divide_tn'] = bv_divide_tn(depth=depth, trade=trade, rolling=120)
    df['av_divide_tn'] = av_divide_tn(depth=depth, trade=trade, rolling=120)
    ...
    df['Open_Interest_Change'] = Open_Interest_Change(depth=None, trade=trade, rolling=120 * 10)
    ...
    df['pv_ic'], df['oi_ic'] = corr_pv(depth=None, trade=trade, rolling=120*10)
    df['flowInRatio'] = flowInRatio(depth=None, trade=trade, rolling=120*10)
    df['large_buy_ratio'], df['large_sell_ratio'] = large_order(depth=None, trade=trade, rolling=120*10)
